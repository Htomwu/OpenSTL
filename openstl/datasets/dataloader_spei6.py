...
def load_data(batch_size, val_batch_size, data_root, num_workers=4,
    ...
    # 加载数据
    train_data = np.load(os.path.join(data_root, "processed_data", "SPEI-6", "train_data_180x360.npy"))
    val_data = np.load(os.path.join(data_root, "processed_data", "SPEI-6", "val_data_180x360.npy"))
    test_data = np.load(os.path.join(data_root, "processed_data", "SPEI-6", "test_data_180x360.npy"))
